...
int menu_order()
{
    ...
    int arID[10],arqty[10],Bill[10],counter=0,decision;

    work:
    printf("\n\t\t\t\tFOOD MENU\n\n");
    printf("\n\t FAST FOOD :\n\n");
    printf("\t1. zinger Burger ...................... 120/=\t  \n");
    printf("\t2. VEG ROLL ..........................  40/=\n");
    printf("\t3. Donuts ...........................  70/=\t \n");
    printf("\t4. French Fries (FnF Pack) ..........  90/=\t \n");
    printf("\t\t\t\t\t\t\t \n\n\t CHICKEN :\n\n");
    printf("\t5. Chicken Broast ...................  90/=\n");
    printf("\t6. Chicken Wings ....................  65/=\n");
    printf("\n\tDESSERTS :\n\t\t\t\t\t\t\t \n");
    printf("\t7. Ice Cream ........................  65/=\t  \n");
    printf("\t8. pudding ........................... 230/=\t \n");
    printf("\n\tDRINKS :\n\n");
    printf("\t9.  7-up ........................ 25/=\n");
    printf("\t10. pepsi   ........................ 25/=\n");
...
void Bill_show(int arID[],int arqty[],int counter)
{
    ...
    char items[10][16]={"zinger Burger","VEG ROLL","Donuts","French Fries","Chicken Broast","Chicken Wings","Ice Cream","pudding","7-up","pepsi"};
